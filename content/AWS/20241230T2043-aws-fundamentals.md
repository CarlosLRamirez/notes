---
id: 20241230T2043-aws-fundamentals
aliases:
  - AWS Fundamentals
tags:
  - AWS
created: 2024-12-30 20:43
folder: AWS
modified: 2025-12-10 09:42
publish: false-
---
[Elastic Compute Cloud (EC2) Basics](<Elastic Compute Cloud (EC2) Basics.md>)
...
- Even the UI present the data in folders, it is a flat structure, what happen is that object keys are like this: _/folder/Koala1.jpg_
...
- The only mandatory part of a template is:
  - A list of resources
- **_Description_** must directly follow **_AWSTemplateFormatVersion_** on a YAML Cloud formation template
