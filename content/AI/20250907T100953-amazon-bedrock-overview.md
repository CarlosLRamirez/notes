...
- Model evaluation
  ...
  - You can use automatic evaluation using metrics like accuracy and toxicity, or you can use human evaluation for things like style, brand and domain knowledge (subjective criteria)
- Customization
  - It support fine-tunning with labeled data for certain models (from Cohere, Meta and Amazon)

---

## Related Notes

[[20250409T0736-introduction-to-ai|Introduction to Artificial Intelligence]]
