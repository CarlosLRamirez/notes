---
id: 20250526T121400-linux-upskill-day-6
aliases:
  - My Linux Upskill Challenge Day 6
tags:
  - linux
created: 2025-05-26 12:14
folder: Linux
...
> [!TIP]
> _"Press ESC twice or more to return to normal mode"_
...
- To **cut** a line, place the cursor anywhere on the line and press `dd` (in _normal mode_). This deletes the entire line and stores it in Vim's clipboard (called the "_unnamed register_").
- To **paste**, press `P` (uppercase). The cut line will be inserted **above** the current line — everything below will move down.
- To cut multiple lines at once, enter `<number-of-lines>dd` in _normal mode_. For example, `5dd` will delete 5 lines starting from the current one, and store them in Vim's clipboard.
