...
# Github
## Concepto Principal
Github es un [Servicio de Control de Versiones](20250115T0446-servicios-de-control-de-versiones.md) el cual inicialmente ofrece el *hosting* administrado de repositorios de Git, sin embargo se ha extendido a proveer otras funcionalidades alrededor del código alojado.  
...
## Aspectos Clave
- No confundir con Git, el cual es el [Sistema de Control de Versiones](20241216T1919-sistema-de-control-de-versiones.md) sobre el cual funciona Github
## Aplicaciones
...
--- 
## Enlaces: 
[20250117T0741-git-vs-github](20250117T0741-git-vs-github.md)
